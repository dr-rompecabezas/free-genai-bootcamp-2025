...
class SitelenPonaRecognizer:
    ...
    def load_templates(self, templates_dir="templates"):
        ...
        for template_file in template_path.glob("*.png"):
            ...
            self.template_embeddings[char_name] = embedding_result.embeddings[0].embedding
        ...
        if st.button("Check Character"):
            ...
            with col2:
                if char:
                    ...
                    st.warning(
                        f"No match found (Best confidence: {confidence:.3f})"
                    )
