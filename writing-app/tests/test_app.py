...
def test_reference_toggle_interaction(app: AppTest):
    ...
    toggle_button = next(
        ...
        if button.label == "Hide Reference"
    )
...
def test_character_selection_callback(app: AppTest):
    ...
    app.session_state[SessionKey.SELECTED_CHAR] = "moku"  # Manually update session state
